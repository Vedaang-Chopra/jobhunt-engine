# Applied AI Researcher, System Discovery — Distyl

- **job_id:** li_distyl_applied_ai_researcher_system_discovery_4315279413
- **source:** linkedin
- **source_id:** li_4315279413
- **location:** New York, NY (Hybrid)
- **url:** https://www.linkedin.com/jobs/view/4315279413/
- **date_discovered:** 2026-08-22
- **queries:** Applied Scientist AI
...
- Analogous to hypothesis generation in the space of AI for scientific discovery, the System Discovery team focuses on identifying entirely new classes of AI systems. Researchers explore a wide range of architectures, modalities, and compositions to uncover how AI can most effectively reshape work
- Draw connections across disparate domains to uncover new system archetypes. Experiment with unconventional problem definitions and develop prototypes that reveal new categories of human–AI collaboration



Who You Are

- Experience Building a Wide Breadth of Systems: You’ve built across many paradigms—retrieval pipelines, reasoning agents, evaluation harnesses, multimodal integrations, or workflow graph systems—and can abstract what makes each effective
