#!/usr/bin/env python3
"""Ingest linkedin_sweep_2026-08-25.json: normalize via discovery_lib, dedupe,
...
SRC = REPO / "execution_results" / "linkedin_sweep_2026-08-25.json"
...
for j in fresh:
    ...
    raw = {
        ...
        "notes": "linkedin guest-api sweep 2026-08-25 past-week US",
    }
...
run_id = f"li_guest_20260825_{datetime.now().strftime('%H%M')}"
